...
<div class="row d-flex justify-content-center">
    <div class="col-md-8  mb-4 mt-4">
        <h2 class="mb-sm-6 pb-sm-2" align="center">Manage permissions</h2>
			    ...
			    {{ select('profileId', profiles, 'using': ['id', 'name'], 'useEmpty': true, 'emptyText': '...', 'emptyValue': '', 'class' : 'form-control mb-2 mb-sm-0') }}
                        ...
                        <div class="">
		            {{ submit_button('Search', 'class': 'btn btn-info', 'name' : 'search') }}
                        </div>
                    </div>
...
{{ submit_button('Save', 'class': 'btn btn-info', 'name':'submit') }}
